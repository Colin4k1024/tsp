 ...
 * delegates to the intentionally retained Python implementation in
 * insaits-security-monitor.py. This is a scoped exception because the
 * third-party InsAIts SDK currently integrates on the Python side.
 *
